<template>
 <div>
    ...
    <Card>
      ...
      <hr>
      <p style="font-size:11px;">外部交易所行情获取：http://127.0.0.1:6010/ermarket/thumb/btcusdt</p>
      <p style="font-size:11px;">获取所有机器人配置：http://127.0.0.1:6010/ernormal/robotList</p>
      <Modal
        v-model="ifDelete"
        title="删除交易对"
        @on-ok="confirmDel"
